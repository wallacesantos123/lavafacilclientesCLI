...
const Higienizacao = ({navigation, route}) => {
    ...
    return(
        ...
        >
            ...
            >
                <Text style={Styles.titulo} >HIGIENIZACÃO</Text>
                <Text style={Styles.txtInfo} >Lavagem da parte externa do carro com direito a pretinho.</Text>
